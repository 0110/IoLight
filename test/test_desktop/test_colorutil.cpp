...
void test_noneColorValues(void) {
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, CALL_COLOREXTARCT("asdf"));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, CALL_COLOREXTARCT("#asdasdas"));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, CALL_COLOREXTARCT("#HelloWorld"));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, CALL_COLOREXTARCT("#00AABBVV"));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, CALL_COLOREXTARCT("#00AABBCCDD"));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, CALL_COLOREXTARCT("#00ccbbaaff"));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, extractColor(NULL, 7));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, extractColor("red", 7));
    TEST_ASSERT_EQUAL(0xFFFFFFFFU, extractColor("#00ff00", 6));
}
